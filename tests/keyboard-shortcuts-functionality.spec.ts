...
test.describe('Keyboard Shortcuts Functionality Test', () => {
  ...
  test('should trigger edit shortcut when collection is selected', async ({
    page,
  }) => {
  ...
  test('should trigger duplicate shortcut when request is selected', async ({
    page,
  }) => {
    const collectionItems = page.locator(
      '[data-testid*="collection"], .collection-item'
  ...
  test('should trigger delete shortcut when item is selected', async ({
    page,
  }) => {
    const collectionItems = page.locator(
      '[data-testid*="collection"], .collection-item'
  ...
  test('should trigger add request shortcut when collection is selected', async ({
    page,
  }) => {
    const collectionItems = page.locator(
      '[data-testid*="collection"], .collection-item'
  ...
  test('should trigger add folder shortcut when collection is selected', async ({
    page,
  }) => {
    const collectionItems = page.locator(
      '[data-testid*="collection"], .collection-item'
  ...
  test('should trigger export shortcut when item is selected', async ({
    page,
  }) => {
    const collectionItems = page.locator(
      '[data-testid*="collection"], .collection-item'
  ...
  test('should not trigger shortcuts when no item is selected', async ({
    page,
  }) => {
  ...
  test('should show visual feedback when item is selected', async ({
    page,
  }) => {
    const collectionItems = page.locator(
      '[data-testid*="collection"], .collection-item'
