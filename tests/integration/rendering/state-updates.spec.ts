...
test.describe('State Updates', () => {
  test('should update database state after collection save', async ({
    electronPage,
    _testDbPath,
  }) => {
    // Get initial state
  ...
  test('should update database state after environment save', async ({
    electronPage,
    _testDbPath,
  }) => {
    // Get initial state
  ...
  test('should update database state after request save', async ({
    electronPage,
    _testDbPath,
  }) => {
  ...
  test('should update collection favorite state', async ({
    electronPage,
    _testDbPath,
  }) => {
    // Create collection
    ...
    const updatedCollection = dbState?.collections?.find(
