...
test.describe('Error States', () => {
  test('should handle invalid collection ID gracefully', async ({
    electronPage,
    testDbPath,
  }) => {
  ...
  test('should handle invalid environment ID gracefully', async ({
    electronPage,
    testDbPath,
  }) => {
  ...
  test('should handle network errors in request send', async ({
    electronPage,
    testDbPath,
  }) => {
    // Create environment
  ...
  test('should handle missing environment in request send', async ({
    electronPage,
    testDbPath,
  }) => {
