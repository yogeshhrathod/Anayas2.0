...
test.describe('Settings IPC Handlers', () => {
  test('settings:get - should return default setting', async ({
    electronPage,
    _testDbPath,
  }) => {
  ...
  test('settings:set - should set setting value', async ({
    electronPage,
    _testDbPath,
  }) => {
  ...
  test('settings:getAll - should return all settings', async ({
    electronPage,
    _testDbPath,
  }) => {
    const result = await electronPage.evaluate(async () => {
  ...
  test('settings:reset - should reset all settings', async ({
    electronPage,
    _testDbPath,
  }) => {
