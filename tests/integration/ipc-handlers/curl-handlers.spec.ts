...
test.describe('cURL IPC Handlers', () => {
  test('curl:parse - should parse simple GET cURL command', async ({
    electronPage,
    testDbPath,
  }) => {
  ...
  test('curl:parse - should parse POST cURL command with headers and body', async ({
    electronPage,
    testDbPath,
  }) => {
  ...
  test('curl:parse - should handle invalid cURL command', async ({
    electronPage,
    testDbPath,
  }) => {
  ...
  test('curl:generate - should generate cURL command from request', async ({
    electronPage,
    testDbPath,
  }) => {
    const request = {
  ...
  test('curl:generate - should generate POST cURL command with headers and body', async ({
    electronPage,
    testDbPath,
  }) => {
    const request = {
  ...
  test('curl:import-bulk - should parse multiple cURL commands', async ({
    electronPage,
    testDbPath,
  }) => {
    const commands = [
  ...
  test('curl:import-bulk - should handle empty array', async ({
    electronPage,
    testDbPath,
  }) => {
