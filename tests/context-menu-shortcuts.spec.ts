...
test.describe('Context Menu Shortcuts Test', () => {
  ...
  test('should show keyboard shortcuts in request context menu', async ({
    page,
  }) => {
  ...
  test('should show keyboard shortcuts in collection context menu', async ({
    page,
  }) => {
    const collectionItems = page.locator(
      '[data-testid*="collection"], .collection-item'
  ...
  test('should not show icons in context menus', async ({ page }) => {
    ...
    if (collectionCount > 0) {
      ...
      if (await contextMenu.isVisible()) {
        ...
        const iconSpans = contextMenu.locator(
          'span:has-text("✏️"), span:has-text("📋"), span:has-text("📤"), span:has-text("📥"), span:has-text("🗑️"), span:has-text("📁"), span:has-text("+")'
        );
  ...
  test('should show appropriate shortcuts for different actions', async ({
    page,
  }) => {
    const collectionItems = page.locator(
      '[data-testid*="collection"], .collection-item'
