 ...
 */
export function calculateOrderAfter(targetOrder: number, nextOrder?: number): number {
 ...
 */
export function calculateOrderBefore(targetOrder: number, prevOrder?: number): number {
