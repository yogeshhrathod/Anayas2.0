    ...
    <div className="space-y-6">
      ...
      <Card>
        ...
        <CardContent className="prose prose-sm dark:prose-invert max-w-none space-y-4">
          ...
          <ul className="list-disc pl-6 space-y-1">
            <li>
              <strong>API URLs, headers, or request bodies</strong>
            </li>
            <li>
              <strong>API responses or data returned from your servers</strong>
            </li>
            <li>
              <strong>Collection names or request names</strong>
            </li>
            <li>
              <strong>Environment variables or secrets</strong>
            </li>
            <li>
              <strong>Any personally identifiable information (PII)</strong>
            </li>
            <li>
              <strong>IP addresses</strong> (Sentry anonymizes these)
            </li>
          </ul>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent className="prose prose-sm dark:prose-invert max-w-none">
          <ul className="list-disc pl-6 space-y-2">
            <li>
              <strong>Fix bugs:</strong> Crash reports help us identify and fix
              issues quickly
            </li>
            <li>
              <strong>Improve UX:</strong> Usage patterns help us prioritize
              features users actually use
            </li>
            <li>
              <strong>Optimize performance:</strong> Performance metrics help us
              find and fix slow areas
            </li>
          </ul>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent className="prose prose-sm dark:prose-invert max-w-none">
          <p>
            We use <strong>Sentry</strong> for error tracking and performance
            monitoring.
          </p>
          <ul className="list-disc pl-6 space-y-1 mt-2">
            <li>
              Sentry is a trusted error tracking service used by thousands of
              companies
            </li>
      ...
      <Card>
        ...
        <CardContent className="prose prose-sm dark:prose-invert max-w-none space-y-4">
          ...
          <ul className="list-disc pl-6 space-y-2">
            <li>
              <strong>Opt out anytime:</strong> Disable telemetry in Settings →
              Privacy & Data
            </li>
            <li>
              <strong>Local data:</strong> All your API data is stored locally
              on your device
            </li>
            <li>
          ...
          <p className="text-sm text-muted-foreground mt-4">
            When you disable telemetry, no data is sent to Sentry. Crash reports
            and analytics are completely turned off.
          </p>
        </CardContent>
      </Card>
