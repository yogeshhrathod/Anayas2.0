  ...
  return (
    <>
      ...
      <div className="relative w-12 flex-shrink-0">
        ...
        <div
          className={`absolute right-0 top-0 bottom-0 transition-all duration-300 z-50 border-l border-border/50 bg-card ${
                    ...
                    <div className="space-y-6 text-left py-2">
                      <div className="space-y-2">
                        ...
                        <p className="text-xs text-muted-foreground leading-relaxed">
                          Scenarios are saved snapshots of your request
                          configurations. They capture the URL, method, headers,
                          and body so you can switch between different test
                          cases (like Success, Error, or Auth) instantly.
                        </p>
                      </div>
                      ...
                      <div className="space-y-2">
                        ...
                        <ul className="text-xs text-muted-foreground space-y-3 p-0">
                          <li className="flex gap-3">
                            <span className="flex-shrink-0 flex items-center justify-center w-5 h-5 rounded-full bg-primary/10 text-primary font-bold text-[10px]">
                              1
                            </span>
                            <span>
                              Configure your request in the main editor.
                            </span>
                          </li>
                          <li className="flex gap-3">
                            <span className="flex-shrink-0 flex items-center justify-center w-5 h-5 rounded-full bg-primary/10 text-primary font-bold text-[10px]">
                            ...
                            <span>
                              Click the{' '}
                              <Plus className="h-3 w-3 inline mb-0.5" /> icon at
                          ...
                          <li className="flex gap-3">
                            ...
                            <span>
                              Restore any saved scenario with a single click
