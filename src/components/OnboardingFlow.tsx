  ...
  const steps = useMemo(
    () => [
      ...
      // Step 2: Features
      {
        ...
        title: 'Built for You',
        description:
          'Everything you need to build, test, and document your APIs in one beautiful app.',
        content: (
      ...
      // Step 3: Ready
      {
        ...
        description:
          "You're all set. Experience a new way of working with APIs.",
        content: (
          <div className="mt-8">
            <Button
              size="lg"
