  ...
  const shortcutCategories = [
    ...
    },
    {
      ...
      shortcuts: [
        ...
        { id: 'CREATE_PRESET', label: 'Create Scenario' },
        { id: 'TOGGLE_PRESETS', label: 'Toggle Scenarios Panel' },
        { id: 'SELECT_PRESET_1', label: 'Select Scenario 1' },
        { id: 'SELECT_PRESET_2', label: 'Select Scenario 2' },
        { id: 'SELECT_PRESET_3', label: 'Select Scenario 3' },
      ],
    },
    {
      title: 'Sidebar',
