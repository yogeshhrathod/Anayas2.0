...
export function BikeLogoAnimation({
  size = 120,
  className,
}: BikeLogoAnimationProps) {
  return (
    <div
      className={cn(
        'relative flex flex-col items-center justify-center overflow-hidden h-[200px] w-[300px]',
        className
      )}
    >
      ...
      <div className="absolute bottom-10 w-[150%] h-[120px] bg-gradient-to-b from-transparent to-muted/10 transform perspective-[500px] rotate-x-60">
        <div className="relative w-full h-full">
          ...
          <motion.div
            ...
            style={{
              backgroundImage:
                'linear-gradient(90deg, transparent 50%, var(--foreground) 50%)',
