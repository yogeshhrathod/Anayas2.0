  ...
  return (
    <div
      className={cn(
        ...
        "bg-[#0f172a] text-white", // Deep dark background for premium feel
    ...
    >
      ...
      >
        ...
        <div className="relative group">
          ...
          <div className="relative bg-white/5 backdrop-blur-xl p-8 rounded-[2.5rem] border border-white/10 shadow-2xl">
        ...
        <div className="mt-16 w-64">
           <div className="flex justify-between mb-2 text-[10px] font-medium uppercase tracking-wider text-white/30">
      ...
      {/* Footer Branding */}
      <div className="absolute bottom-12 text-white/20 text-xs font-light tracking-widest uppercase">
        Version 2.0
      </div>
    </div>
  );
