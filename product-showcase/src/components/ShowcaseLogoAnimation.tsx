...
export function ShowcaseLogoAnimation({
  size = 120,
  className,
}: ShowcaseLogoAnimationProps) {
  return (
    <div
      className={cn(
        'relative flex flex-col items-center justify-center overflow-hidden h-[300px] w-full max-w-[500px]',
        className
      )}
    >
